...
class EnhancedTable extends Component {
    ...
    render() {
        const { classes, data, selected, handleClickOpen, handleClickEdit, handleClickPermission, handleClickDelete } = this.props;
        ...
        return (
            <Paper className={classes.root}>
                <EnhancedTableToolbar 
                    ...
                    openPermission={handleClickPermission}>
                </EnhancedTableToolbar>
                                    ...
                                    return (
                                        <TableRow
                                            ...
                                            <TableCell align="left">
                                                <Radio disabled checked={n.isAdmin === 'TRUE' ? true : false} />
                                            </TableCell>
                                        </TableRow>
                                    );
                                })}
